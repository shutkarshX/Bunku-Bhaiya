(() => {
  ...
  function setupLoginScene() {
    ...
    content.appendChild(loginSection); scene.append(veil, spider, glow, noise, content, status); document.body.appendChild(scene);
    document.documentElement.style.overflow = "hidden"; document.body.style.overflow = "hidden";
    let started = false, raf = 0, targetX = 0, targetY = 0, currentX = 0, currentY = 0;
    const head = spider.querySelector(".tein-spider-head"), body = spider.querySelector(".tein-spider-body");
